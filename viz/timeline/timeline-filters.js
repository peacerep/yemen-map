...
function callFunction() {
  ...
  d3.csv("PAX_with_additional.csv")
      ...
      .get(function(error,data){
          ...
          //   if (selected == "HrGen") {
          //     data = data.filter(function(d){ return d.HrGen > 0; });
          //   }
          //   if (selected == "Pol") {
          //     data = data.filter(function(d){ return d.Pol > 0; });
          //   }
          //   if (selected == "Eps") {
          //     data = data.filter(function(d){ return d.Eps > 0; });
          //   }
          //   if (selected == "Mps") {
          //     data = data.filter(function(d){ return d.Mps > 0; });
          //   }
          //   if (selected == "Terps") {
          //     data = data.filter(function(d){ return d.Terps > 0; });
          //   }
          //   if (selected == "TjMech") {
          //     data = data.filter(function(d){ return d.TjMech > 0; });
          //   }
          //   if (selected == "GeWom") {
        ...
        */
        d3.select(".dropdown").select(".dropdown-content").select("#GeWom").on("click", function() {
          data = data.filter(function(d){ return d.GeWom > 0; });
          yr_count_array = d3.nest()
               .key(function(d) {return d.Year;}).sortKeys(d3.ascending)
               .rollup(function(leaves){ return leaves.length; })
               .entries(data);
