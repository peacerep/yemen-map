...
function toUpdate(){
  if (window.localStorage.getItem("updatePaxVerticalB") == "true"){
    return callFunction();
  }
}
      ...
      .get(function(error,data){
          ...
          */
          chartGroup.append("text")
                      ...
                      .text(localStorage.getItem("paxVertConB"));
          // chartGroup.append("text")
          //             .attr("x", "0px")
          //             .attr("y", margin.top*5)
          //             .attr("class","description")
          ...
          */
          ...
          // }
           ...
           function setVertAgtFilters(d){
             var agmtCodes = [d.HrFra, d.Eps, d.Mps, d.Pol, d.Polps, d.Terps, d.TjMech, d.GeWom]; //d.HrFra,
             var codeFilters = [+paxHrFra, +paxEps, +paxMps, +paxPol, +paxPolps, +paxTerps, +paxTjMech, +paxGeWom]; // +paxHrFra,
             var codeFilterCount = codeFilters.length;
             if (paxANY == 1){
               for (i = 0; i < codeFilterCount; i++){
