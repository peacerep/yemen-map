...
//.attr("fill-opacity",function(d){ return d.GeWom == 1 ? "1" : "0.2"; })
        ...
        // d3.map(years, function(d, i){ console.log(yr_count_array[i]);}); // returns object
        // d3.map(years, function(d, i){ console.log(yr_count_array[i].key);}); // returns year
        // d3.map(years, function(d, i){ console.log(yr_count_array[i].value);}); // returns value
